...
export const dict = {
  ...
  "ca.copy": { en: "Copy CA", es: "Copiar CA" },
  "ca.copied": { en: "Copied!", es: "¡Copiado!" },
  "ca.failed": { en: "Couldn't copy", es: "No se pudo copiar" },
  "ca.aria": { en: "Copy contract address {addr}", es: "Copiar la dirección del contrato {addr}" },
  "ca.noMarket.title": { en: "This token has no market on PANDA", es: "Este token no tiene mercado en PANDA" },
  "ca.noMarket.body": { en: "PANDA found the address but no pool to trade it on (Pump.fun, PumpSwap or other Solana DEXes), so there is no price, chart or trading here.", es: "PANDA encontró la dirección pero ningún pool donde operarlo (Pump.fun, PumpSwap u otros DEX de Solana), así que aquí no hay precio, gráfico ni trading." },
  "ca.noMarket.unnamed": { en: "Unnamed token", es: "Token sin nombre" },
  ...
  "pf.change24h": { en: "24h", es: "24 h" },
  "pf.change24hCovers": { en: "Based on {n} of {m} priced holdings — the others have no 24h figure.", es: "Basado en {n} de {m} tenencias con precio — las demás no tienen dato de 24 h." },
  "pf.hidden": { en: "{n} hidden token(s) that look like spam (ads airdropped to your wallet)", es: "{n} token(s) oculto(s) que parecen spam (publicidad enviada a tu wallet)" },
  "pf.showHidden": { en: "Show", es: "Mostrar" },
  "pf.hideHidden": { en: "Hide", es: "Ocultar" },
