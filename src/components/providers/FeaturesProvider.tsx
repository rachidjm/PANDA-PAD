 ...
 */
export type Features = { themes: boolean; branches: boolean; market: boolean; points: boolean; airdrops: boolean; claims: boolean; strategies: boolean; otcRewards: boolean; holderRewards: boolean };

const OFF: Features = { themes: false, branches: false, market: false, points: false, airdrops: false, claims: false, strategies: false, otcRewards: false, holderRewards: false };
